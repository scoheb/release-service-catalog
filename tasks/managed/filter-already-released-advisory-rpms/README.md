...
| PULP_PUBLIC_DOMAIN       | When set, overrides PULP_DOMAIN for checking existing RPMs. Used in signing workflows to check the public domain where signed RPMs end up. | Yes      | ""                           |
