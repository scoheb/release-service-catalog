...
function internal-pipelinerun() {
  ...
  echo $* >> $(workspaces.data.path)/$(params.subdirectory)/mock_internal-pipelinerun.txt
...
function set_plr_status() {
    ...
    sleep $DELAY
    PATCH_FILE=$(workspaces.data.path)/$(params.subdirectory)/${NAME}-patch.json
    status="True"
...
function internal-request() {
  ...
  echo $* >> $(workspaces.data.path)/$(params.subdirectory)/mock_internal-request.txt
...
function find_signatures() {
  echo $* >> $(workspaces.data.path)/$(params.subdirectory)/mock_find_signatures.txt
